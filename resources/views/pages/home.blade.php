...
$cases = [
    [
        ...
        'detail' => 'Health-Tech — 150+ Employees',
        'image'  => 'board_room.jpeg',
    ],
    [
        'tab'    => 'Event & Hosting',
        'sub'    => '40+ Employees',
        'label'  => 'Hospitality · Rapid Scaling',
        'body'   => 'Built the organisational design and people management frameworks for a rapidly scaling hospitality brand moving from founder-led operations to a professionally managed structure.',
        'detail' => 'Event & Hosting — 40+ Employees',
        'image'  => 'couch_talk.jpeg',
    ],
    [
        'tab'    => 'Advisory Firm',
        'sub'    => '20+ Employees',
        'label'  => 'Professional Services · Governance',
        'body'   => 'Established the HR governance architecture, compliance frameworks, and leadership development pathways for a growing advisory firm requiring institutional-grade people systems.',
        'detail' => 'Advisory Firm — 20+ Employees',
        'image'  => 'one_on_one.jpeg',
    ],
    [
        'tab'    => 'Creative Co',
        'sub'    => '10+ Employees',
        'label'  => 'Creative Industry · Foundation',
        'body'   => 'Designed the foundational people architecture for an ambitious creative agency — from onboarding and role clarity to performance management and culture infrastructure.',
        'detail' => 'Creative Co — 10+ Employees',
